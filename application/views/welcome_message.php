      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title" name="txt_title">Info</h4>
              </div>
...
<div id="container">
	...
	<div id="body">
		...
		<p>Push the button to test the style and the script. <input class="btn btn-primary" type="button" id='btn_test' value="Click Me..."></p>
