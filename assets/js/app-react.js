...
function Greetings(props) {
    return props.isLoggedIn ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h1', null, 'Welcome Back ', props.name) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h1', null, 'Please Login');
}
...
var LoginControl = function (_React$Component) {
    ...
    _createClass(LoginControl, [{
        ...
        value: function render() {
            ...
            var btn = void 0;
            if (isLoggedIn) {
                btn = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { onClick: this.handleLogout }, this.state.btn_text);
            } else {
                btn = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { onClick: this.handleLogin }, this.state.btn_text);
            }
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Greetings, { isLoggedIn: this.state.isLoggedIn, name: this.state.name }), btn);
        }
    }]);
...
var ListItem = function (_React$Component2) {
    ...
    _createClass(ListItem, [{
        key: 'render',
        value: function render() {
            var listItems = this.props.listItems.map(function (number) {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li', { key: number.toString() }, number);
            });
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul', null, listItems);
        }
    }]);
...
var el = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ListItem, { listItems: numbers });
